...
class MaintenanceItemPolicy
{
    ...
    {
        return $user->can('view_any_panel::maintenance::item');
    }
    ...
    {
        return $user->can('view_panel::maintenance::item');
    }
    ...
    {
        return $user->can('create_panel::maintenance::item');
    }
    ...
    {
        return $user->can('update_panel::maintenance::item');
    }
    ...
    {
        return $user->can('delete_panel::maintenance::item');
    }
    ...
    {
        return $user->can('delete_any_panel::maintenance::item');
    }
     ...
     */
    public function replicate(User $user, MaintenanceItem $maintenanceItem): bool
    {
